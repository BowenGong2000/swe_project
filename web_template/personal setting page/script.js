...
! function(t) {
    ...
    return function t(e, n, i) {
        function r(o, a) {
            if (!n[o]) {
                if (!e[o]) { var l = "function" == typeof require && require; if (!a && l) return l(o, !0); if (s) return s(o, !0); var u = new Error("Cannot find module '" + o + "'"); throw u.code = "MODULE_NOT_FOUND", u }
                var h = n[o] = { exports: {} };
                e[o][0].call(h.exports, function(t) { var n = e[o][1][t]; return r(n ? n : t) }, h, h.exports, t, e, n, i)
            }
            return n[o].exports
        }
        ...
        1: [function(t, e, n) {
            ...
            function i(t, e) { return function() { return t.apply(e, arguments) } }
        ...
        2: [function(t, e, n) {
            ...
            e.exports = i, i.EventEmitter = i, i.prototype._events = void 0, i.prototype._maxListeners = void 0, i.defaultMaxListeners = 10, i.prototype.setMaxListeners = function(t) { if (!s(t) || 0 > t || isNaN(t)) throw TypeError("n must be a positive number"); return this._maxListeners = t, this }, i.prototype.emit = function(t) {
                var e, n, i, s, l, u;
                if (this._events || (this._events = {}), "error" === t && (!this._events.error || o(this._events.error) && !this._events.error.length)) { if (e = arguments[1], e instanceof Error) throw e; var h = new Error('Uncaught, unspecified "error" event. (' + e + ")"); throw h.context = e, h }
        ...
        4: [function(t, e, n) {
            ...
            function i(t) { if (null === t || void 0 === t) throw new TypeError("Object.assign cannot be called with null or undefined"); return Object(t) }

            function r() { try { if (!Object.assign) return !1; var t = new String("abc"); if (t[5] = "de", "5" === Object.getOwnPropertyNames(t)[0]) return !1; for (var e = {}, n = 0; 10 > n; n++) e["_" + String.fromCharCode(n)] = n; var i = Object.getOwnPropertyNames(e).map(function(t) { return e[t] }); if ("0123456789" !== i.join("")) return !1; var r = {}; return "abcdefghijklmnopqrst".split("").forEach(function(t) { r[t] = t }), "abcdefghijklmnopqrst" !== Object.keys(Object.assign({}, r)).join("") ? !1 : !0 } catch (s) { return !1 } }
            var s = Object.getOwnPropertySymbols,
                o = Object.prototype.hasOwnProperty,
                a = Object.prototype.propertyIsEnumerable;
            e.exports = r() ? Object.assign : function(t, e) { for (var n, r, l = i(t), u = 1; u < arguments.length; u++) { n = Object(arguments[u]); for (var h in n) o.call(n, h) && (l[h] = n[h]); if (s) { r = s(n); for (var c = 0; c < r.length; c++) a.call(n, r[c]) && (l[r[c]] = n[r[c]]) } } return l }
        }, {}],
        5: [function(t, e, n) {
            (function(t) {
                (function() { var n, i, r; "undefined" != typeof performance && null !== performance && performance.now ? e.exports = function() { return performance.now() } : "undefined" != typeof t && null !== t && t.hrtime ? (e.exports = function() { return (n() - r) / 1e6 }, i = t.hrtime, n = function() { var t; return t = i(), 1e9 * t[0] + t[1] }, r = n()) : Date.now ? (e.exports = function() { return Date.now() - r }, r = Date.now()) : (e.exports = function() { return (new Date).getTime() - r }, r = (new Date).getTime()) }).call(this)
            }).call(this, t("_process"))
        }, { _process: 7 }],
        6: [function(t, e, n) {
            function i(t) { if (t = t.replace(/-([a-z])/g, function(t, e) { return e.toUpperCase() }), void 0 !== o[t]) return t; for (var e = t.charAt(0).toUpperCase() + t.slice(1), n = a.length; n--;) { var i = a[n] + e; if (void 0 !== o[i]) return i } return t }

            function r(t) { return t in u ? u[t] : u[t] = i(t) }

            function s(t) { return t = i(t), l.test(t) && (t = "-" + t.replace(l, "-$1"), l.lastIndex = 0), t.toLowerCase() }
        ...
        7: [function(t, e, n) {
            ...
            function s(t) { if (c === setTimeout) return setTimeout(t, 0); if ((c === i || !c) && setTimeout) return c = setTimeout, setTimeout(t, 0); try { return c(t, 0) } catch (e) { try { return c.call(null, t, 0) } catch (e) { return c.call(this, t, 0) } } }
            ...
            function a() { y && v && (y = !1, v.length ? d = v.concat(d) : m = -1, d.length && l()) }
            ...
            function h() {}
            var c, f, p = e.exports = {};
            ! function() { try { c = "function" == typeof setTimeout ? setTimeout : i } catch (t) { c = i } try { f = "function" == typeof clearTimeout ? clearTimeout : r } catch (t) { f = r } }();
            var v, d = [],
                y = !1,
                m = -1;
                        ...
                        if (0 === f.length) {
                            ...
                            h = n + e, setTimeout(function() {
                                ...
                                for (var e = 0; e < t.length; e++)
                                    if (!t[e].cancelled) try { t[e].callback(h) } catch (n) { setTimeout(function() { throw n }, 0) }
                            }, Math.round(n))
                        }
                        return f.push({ handle: ++c, callback: t, cancelled: !1 }), c
                    }, l = function(t) { for (var e = 0; e < f.length; e++) f[e].handle === t && (f[e].cancelled = !0) }
                }
                e.exports = function(t) { return a.call(r, t) }, e.exports.cancel = function() { l.apply(r, arguments) }, e.exports.polyfill = function() { r.requestAnimationFrame = a, r.cancelAnimationFrame = l }
        ...
        9: [function(t, e, n) {
            ...
            i.prototype = {
                ...
                once: function(t, e, n) {
                    function i() { r.off(t, i), e.apply(n, arguments) }
                    var r = this;
        ...
        11: [function(t, e, n) {
            ...
            i.prototype._notify = function(t) {
                ...
                var t = this._event;
                t.x = 0, t.y = 0
            }, i.prototype.destroy = function() { this._emitter.off(), this._unbind() }
        }, { "./clone": 10, "./support": 12, "bindall-standalone": 1, lethargy: 3, "object-assign": 4, "tiny-emitter": 9 }],
        12: [function(t, e, n) {
            "use strict";
        ...
        13: [function(t, e, n) {
            ...
            function s(t, e) { if (!t) throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); return !e || "object" != ("undefined" == typeof e ? "undefined" : a(e)) && "function" != typeof e ? t : e }
            ...
            var l = function() {
                ...
                d = i(v),
                y = function(t) {
                    function e(t) { r(this, e); var n = s(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this)); return n._bind(), n.options = Object.assign({ container: t.container, blocks: t.blocks, isAnimated: t.isAnimated || !1, spring: t.spring || .1, skewReducer: t.skewReducer || 20, skewLimit: t.skewLimit || 30 }, t), n.vars = { scrollValue: 0, oldScrollValue: 0, scrollTarget: 0, scrollLeft: 0, scrollRight: 0, spring: n.options.spring, direction: 0, speed: 0, speedTarget: 0 }, n.wrapper = document.createElement("div"), n.wrapper.setAttribute("class", "horizontal-scroll"), n.vs = new c["default"], n.transform = d["default"]("transform"), n.raf = p["default"], n._setUI(), n._addEvents(), n.onResize(), n }
                    return o(e, t), l(e, [{ key: "_bind", value: function() { this._update = this._update.bind(this), this.onResize = this.onResize.bind(this) } }, { key: "_addEvents", value: function() { this.vs.on(this._onScroll, this), this.raf(this._update), window.addEventListener("resize", this.onResize) } }, { key: "_removeEvents", value: function() { this.raf.cancel(this._update), this.raf(this._update), window.removeEventListener("resize", this.onResize) } }, {
                        key: "_setUI",
                        value: function() {
                            var t = this;
                            Object.assign(this.wrapper.style, { position: "absolute", top: "0", left: "0", "backface-visibility": "hidden", "will-change": "transform" }), Object.assign(this.options.container[0].style, { "white-space": "nowrap", position: "relative" }), Array.prototype.forEach.call(this.options.blocks, function(e) { e.style.display = "inline-block", t.options.container[0].replaceChild(t.wrapper, e), t.wrapper.appendChild(e) }), this.options.container[0].appendChild(this.wrapper)
                        }
                    }, { key: "_onScroll", value: function(t) { t.deltaY > 0 ? this.vars.direction = 1 : this.vars.direction = -1, this.vars.scrollTarget += -1 * t.deltaY, this.vars.scrollTarget = Math.round(Math.max(this.vars.scrollLeft, Math.min(this.vars.scrollTarget, this.vars.scrollRight))) } }, {
                        key: "_update",
                        value: function() {
                    ...
                    }, { key: "_clamp", value: function(t, e, n) { return Math.min(Math.max(t, e), n) } }, { key: "onResize", value: function() { this.vars.scrollLeft = 0, this.vars.scrollRight = this.wrapper.getBoundingClientRect().width - window.innerWidth } }, { key: "destroy", value: function() { this._removeEvents() } }]), e
                }(u.EventEmitter);
            n["default"] = y
